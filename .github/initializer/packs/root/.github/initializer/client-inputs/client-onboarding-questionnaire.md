...
Example: `Xome`, `Acme Insurance`, `Northwind Retail`

**2. What is the name of the project or application we will support?**  
Example: `Customer Portal`, `Claims Processing App`, `Vendor Onboarding System`
...
Example: `Java`, `C#`, `TypeScript`, `Python`, `SQL`

**5. Which frameworks or libraries does your team use most often?**  
Example: `React`, `Angular`, `ASP.NET Core`, `Spring Boot`, `Node.js`, `Django`

**6. What kind of testing tools or test approach do you use?**  
Example: `JUnit`, `xUnit`, `Vitest`, `Playwright`, `Selenium`, `manual testing`

**7. What kind of database or data storage do you use?**  
Example: `SQL Server`, `PostgreSQL`, `Oracle`, `MySQL`, `MongoDB`

**8. Where is the application usually hosted or deployed?**  
Example: `Azure`, `AWS`, `on-premises servers`, `Kubernetes`
